...
export function ContatoSection() {
  return (
    <section
      id="contato"
      className="relative z-10 section-padding bg-bg-0 text-center"
    >
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <RevealBlock delay={0.1}>
          <h2
            className="font-display font-extrabold leading-[1.05] tracking-[-0.03em] mb-14"
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {CONTACT_DATA.map((item, i) => (
            <RevealBlock key={item.type} delay={0.2 + i * 0.08}>
              <motion.a
                href={item.href}
                target={item.type !== "email" ? "_blank" : undefined}
                rel="noopener noreferrer"
                className="flex items-center gap-3 px-7 py-4 border border-white/[0.06] text-muted text-[0.9rem] font-body hover:text-ice bg-bg-1 transition-colors duration-300 group"
                whileHover={{
                  y: -2,
              ...
              >
                <span className="text-muted group-hover:text-accent-bright transition-colors duration-300">
        ...
        <RevealBlock delay={0.5}>
          <div className="mt-20 flex items-center gap-6 max-w-xs mx-auto">
