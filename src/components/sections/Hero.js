...
const DavidPortrait = styled.img`
  position: absolute;
  inset: 2%;
  width: 96%;
  height: 96%;
  ...
  pointer-events: none;
  user-select: none;
  border-radius: 44% 56% 48% 52% / 36% 38% 62% 64%;
...
export default function Hero() {
  ...
  /* ── 12 Badges Config ── */
  const BADGES = [
    { name: 'Next.js', emoji: '▲', color: '#a0a0a0', percent: '95%' },
    { name: 'TypeScript', emoji: 'TS', color: '#3178C6', percent: '92%' },
    { name: 'React', emoji: '⚛️', color: '#61DAFB', percent: '94%' },
    { name: 'Node.js', emoji: '🟢', color: '#68A063', percent: '90%' },
    { name: 'IA / LLMs', emoji: 'AI', color: '#8B5CF6', percent: '90%' },
    { name: 'APIs', emoji: '🔌', color: '#009688', percent: '94%' },
    { name: 'PostgreSQL', emoji: '🐘', color: '#336791', percent: '86%' },
    { name: 'Docker', emoji: '◈', color: '#2496ED', percent: '82%' },
    { name: 'Tailwind', emoji: 'TW', color: '#38BDF8', percent: '92%' },
    { name: 'Automação', emoji: '⚙️', color: '#F59E0B', percent: '93%' },
    { name: 'Security', emoji: '◉', color: '#10B981', percent: '84%' },
    { name: 'Cloud', emoji: '☁️', color: '#60A5FA', percent: '86%' },
  ];
    ...
    <HeroSection id="hero" ref={heroRef}>
      ...
      <HeroContainer>
        ...
        <TextColumn ref={textColumnRef}>
          ...
          <SocialLinks>
            <SocialIcon href={profile.github} target="_blank" rel="noopener noreferrer" aria-label="GitHub"><FiGithub /></SocialIcon>
            <SocialIcon href={profile.whatsapp} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"><FaWhatsapp /></SocialIcon>
            <SocialIcon href={profile.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram"><FiInstagram /></SocialIcon>
          </SocialLinks>
        </TextColumn>
        ...
        <AvatarColumn ref={avatarColumnRef}>
          <AvatarWrapper ref={avatarRef}>
            ...
            <AvatarFrame
              ref={frameImgRef}
              role="img"
              aria-label="David Budeli"
            />
            <DavidPortrait src={profile.portrait} alt="Retrato de David Budeli" />
          </AvatarWrapper>
        </AvatarColumn>
