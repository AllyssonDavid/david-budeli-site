  ...
  return (
    <FooterSection>
      ...
      <CtaArea>
        ...
        <CtaButtons>
          <MagneticButton>
            <CtaBtn href={profile.whatsappMessage} target="_blank" rel="noopener noreferrer">
              <FaWhatsapp /> {t('nav.letsTalk')}
            </CtaBtn>
          </MagneticButton>
          <MagneticButton>
            <CtaBtnOutline href={profile.github} target="_blank" rel="noopener noreferrer">
              <FaGithub /> GitHub
            </CtaBtnOutline>
          </MagneticButton>
        </CtaButtons>
      ...
      <FooterBody>
        <FooterInner>
          ...
          <BrandCol>
            ...
            <FooterSocials>
              <SocialBtn href={profile.github} target="_blank" rel="noopener noreferrer" title="GitHub"><FaGithub /></SocialBtn>
              <SocialBtn href={profile.whatsapp} target="_blank" rel="noopener noreferrer" title="WhatsApp"><FaWhatsapp /></SocialBtn>
              <SocialBtn href={profile.instagram} target="_blank" rel="noopener noreferrer" title="Instagram"><FaInstagram /></SocialBtn>
            </FooterSocials>
          </BrandCol>
          ...
          <StatusCard>
            ...
            <EmailRow><FiMail size={12} /> {profile.email}</EmailRow>
            <StatusBtn href={profile.whatsappMessage} target="_blank" rel="noopener noreferrer">
              {t('nav.letsTalk')} →
            </StatusBtn>
          </StatusCard>
        </FooterInner>
