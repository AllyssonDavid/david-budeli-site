      ...
      <ContactContainer>
        ...
        <ContactLayout>
          ...
          <LeftPanel>
            ...
            <ContactInfoCards>
              <InfoCard onClick={copyEmail} $isRTL={isRTL}>
                ...
                <InfoCardContent>
                  ...
                  <InfoCardValue>
                    {copiedEmail ? <span style={{ color: '#10b981' }}>{t('contact.copiedSucc') || 'Copied ✓'}</span> : profile.email} 
              ...
              <InfoCard $isRTL={isRTL}>
                ...
                <InfoCardContent>
                  ...
                  <InfoCardValue>{t('contact.locationValue') || 'Brasil'}</InfoCardValue>
                </InfoCardContent>
              </InfoCard>
            </ContactInfoCards>
            ...
            <SocialsRow>
              <SocialBtn href={profile.github} target="_blank" rel="noopener noreferrer" title="GitHub">
                <FaGithub />
              </SocialBtn>
              <SocialBtn href={profile.whatsapp} target="_blank" rel="noopener noreferrer" title="WhatsApp">
                <FaWhatsapp />
              </SocialBtn>
              <SocialBtn href={profile.instagram} target="_blank" rel="noopener noreferrer" title="Instagram">
                <FaInstagram />
              </SocialBtn>
            </SocialsRow>
          </LeftPanel>
