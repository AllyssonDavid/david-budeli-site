...
const ThemePreview = styled.div`
  ...
  background: ${({ $dark }) =>
    $dark
      ? 'linear-gradient(135deg, #020304, #0c1117)'
...
export default function PreferencesPopup() {
  ...
  return (
    <>
      ...
      <Modal>
        <ModalHeader>
          <FloatingOrb $size={120} $color="#39D0C255" $top="-30px" $right="-20px" $speed="5s" $blur={50} />
          <FloatingOrb $size={80} $color="#39AEEA33" $top="20px" $left="-30px" $speed="7s" $blur={40} />
          <Emoji>✨</Emoji>
